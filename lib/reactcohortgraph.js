            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    header.map(function (headerCell, i) {
                        return _react2.default.createElement(
                            _components.HeaderCell,
                            _extends({ key: "header" + i }, headerCell),
                            headerCell.value
                        );
                    })
                ),
                    ...
                    rows.map(function (row, j) {
                        return _react2.default.createElement(
                            ...
                            row.map(function (cell, k) {
                                return _react2.default.createElement(
                                    _components.BodyCell,
                                    _extends({ key: "cell" + k }, cell),
                                    ' ',
                                    cell.value,
                                    ' '
                                );
                    ...
                    if (data[key].hasOwnProperty(anotherKey)) {
                        ...
                        _this.store[key].push([cellData].concat(_toConsumableArray(data[key][anotherKey].map(function (value, index) {
                            ...
                            return {
                                ...
                                percent: percent,
                                color: index === 0 ? _styles.DEFAULT_CELL_COLOR : _this._shadeCellWithColor(percent)
                            };
                        }))));
                    }
                };
            ...
            if (_this.store.hasOwnProperty(key)) {
                ...
                largeRow.forEach(function (el, index) {
                    ...
                    _this.headers[key].push({
                        ...
                        total: cellData.total,
                        percent: percent,
                        color: _this._shadeCellWithColor(percent)
                    });
                });
            }
        };
...
exports.HeaderCell = exports.BodyCell = undefined;
