            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    header.map(function (headerCell, i) {
                        return _react2.default.createElement(_components.HeaderCell, _extends({ key: "header" + i }, headerCell, { valueType: valueType }));
                    })
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    rows.map(function (row, j) {
                        return _react2.default.createElement(
                            ...
                            row.map(function (cell, k) {
                                return _react2.default.createElement(_components.BodyCell, _extends({ key: "cell" + k }, cell, { valueType: valueType }));
                            })
                        );
                    })
                )
...
ReactCohortGraph.propTypes = {
    ...
    maxWeeks: _propTypes2.default.number,
    maxMonths: _propTypes2.default.number,
        ...
        var _loop3 = function _loop3(key) {
            if (_this.store.hasOwnProperty(key)) {
                ...
                largeRow.forEach(function (el, index) {
                    ...
                    var percent = _this._getPercentage(_this._sumOfFirstColumnUpToIndex(_this.store[key], totalRows - index + 1), value);
...
exports.BodyCell = exports.HeaderCell = undefined;
