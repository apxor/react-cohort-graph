...
var ReactCohortGraph = function (_React$Component) {
    ...
    function ReactCohortGraph(props) {
        ...
        _this.state = {
            ...
            currentType: "",
            valueType: _constants.VALUE_KEYS.PERCENT
        };
        return _this;
    }
...
ReactCohortGraph.propTypes = {
    ...
    dataType: _propTypes2.default.string.isRequired, //keys of data
...
var HeaderCell = exports.HeaderCell = function HeaderCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, _styles.TableCell, { backgroundColor: props.color }) },
        _react2.default.createElement(
            'p',
...
var BodyCell = exports.BodyCell = function BodyCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, _styles.TableCell, { backgroundColor: props.color }), title: 'Out of ' + props.total + ' on ' + props.valueFor },
        renderValue(props)
    );
};
