(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactCohortGraph"] = factory();
	else
		root["ReactCohortGraph"] = factory();
})(this, function() {
...
var DEFAULT_BODY_CELL_COLOR = exports.DEFAULT_BODY_CELL_COLOR = "#F5F5F5";
var DEFAULT_KEY_CELL_COLOR = exports.DEFAULT_KEY_CELL_COLOR = "#F6F6F6";
var DEFAULT_HEADER_CELL_COLOR = exports.DEFAULT_HEADER_CELL_COLOR = "#F5F5F5";
var DEFAULT_SHADE_COLOR = exports.DEFAULT_SHADE_COLOR = "#3f83a3";

var DEFAULT_BORDER = exports.DEFAULT_BORDER = "1px solid #F1F1F1";
...
var headerValue = exports.headerValue = function headerValue() {
    var custom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return _extends({
        fontSize: '12px'
    }, custom);
...
var headerLabel = exports.headerLabel = function headerLabel() {
    var custom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return _extends({
        fontSize: '16px',
        padding: '0',
...
var fixedTablePart = exports.fixedTablePart = function fixedTablePart() {
    var custom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return _extends({
        display: 'table-cell',
        minWidth: '200px'
...
var scrollableTableContent = exports.scrollableTableContent = function scrollableTableContent() {
    var custom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return _extends({
        position: 'relative',
        display: 'block'
...
var scrollableTablePart = exports.scrollableTablePart = function scrollableTablePart() {
    var custom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return {
        display: 'table-cell',
        overflowX: 'auto',
...
var _DataStore = __webpack_require__(23);
...
var ReactCohortGraph = function (_React$Component) {
    _inherits(ReactCohortGraph, _React$Component);

    function ReactCohortGraph(props) {
        _classCallCheck(this, ReactCohortGraph);

        var _this = _possibleConstructorReturn(this, (ReactCohortGraph.__proto__ || Object.getPrototypeOf(ReactCohortGraph)).call(this, props));

        _initialiseProps.call(_this);

        var _props$data = props.data,
            data = _props$data === undefined ? {} : _props$data,
            _props$defaultValueTy = props.defaultValueType,
            defaultValueType = _props$defaultValueTy === undefined ? _constants.VALUE_KEYS.PERCENT : _props$defaultValueTy,
            shadeColor = props.shadeColor;

        _this.state = {
            dataStore: _this._getStore(props),
            currentType: "",
    ...
    _createClass(ReactCohortGraph, [{
        ...
        value: function componentWillMount() {
            var _props = this.props,
                data = _props.data,
                onStoreUpdate = _props.onStoreUpdate;
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                _props2$showEmptyData = _props2.showEmptyDataMessage,
                ...
                showHeaderValues = _props2.showHeaderValues,
                ...
                headerCellStyles = _props2$headerCellSty === undefined ? {} : _props2$headerCellSty,
                tableStyles = _props2.tableStyles,
                tableRowStyles = _props2.tableRowStyles,
                tableHeadingStyles = _props2.tableHeadingStyles,
                tableBodyStyles = _props2.tableBodyStyles,
                fixedTablePartStyles = _props2.fixedTablePartStyles,
                wrapperStyles = _props2.wrapperStyles,
                scrollableTablePartStyles = _props2.scrollableTablePartStyles,
                scrollableTableContentStyles = _props2.scrollableTableContentStyles,
                headerLabelStyles = _props2.headerLabelStyles,
                tableCellStyles = _props2.tableCellStyles;
            ...
            if (header && header.length > 0) {
                return _react2.default.createElement(
                    'div',
                    { style: WrapperStyles },
                    this.renderChildren(_extends({}, this.props, this.state)),
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            header.map(function (headerCell, i) {
                                                return _this2.isFixed(i) && _react2.default.createElement(_components.HeaderCell, _extends({ tableCellStyles: tableCellStyles, headerLabelStyles: headerLabelStyles, style: headerCellStyles, key: "header" + i }, headerCell, { headerFormatter: headerFormatter, showHeaderValues: showHeaderValues, valueType: valueType }));
                                            })
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            ...
                                            rows.map(function (row, j) {
                                                return _react2.default.createElement(
                                                    'div',
                                                    { style: TableRowStyles, key: "row" + j },
                                                    row.map(function (cell, k) {
                                                        return _this2.isFixed(k) && _react2.default.createElement(_components.BodyCell, _extends({ tableCellStyles: tableCellStyles, style: bodyCellStyles, key: "cell" + k }, cell, { valueType: valueType, labelFormatter: labelFormatter }));
                                                    })
                                                );
                                            })
                                        )
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                { style: TableHeadingStyles },
                                                header.map(function (headerCell, i) {
                                                    return !_this2.isFixed(i) && _react2.default.createElement(_components.HeaderCell, _extends({ tableCellStyles: tableCellStyles, style: headerCellStyles, key: "header" + i }, headerCell, { headerFormatter: headerFormatter, showHeaderValues: showHeaderValues, valueType: valueType }));
                                                })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                ...
                                                rows.map(function (row, j) {
                                                    return _react2.default.createElement(
                                                        ...
                                                        { style: TableRowStyles, key: "row" + j },
                                                        row.map(function (cell, k) {
                                                            return !_this2.isFixed(k) && _react2.default.createElement(_components.BodyCell, _extends({ tableCellStyles: tableCellStyles, style: bodyCellStyles, key: "cell" + k }, cell, { valueType: valueType }));
                                                        })
                                                    );
                                                })
                                            )
...
var _initialiseProps = function _initialiseProps() {
    this._getStore = function (props) {
        var _props$data2 = props.data,
            data = _props$data2 === undefined ? {} : _props$data2,
            _props$shadeColor = props.shadeColor,
            shadeColor = _props$shadeColor === undefined ? _styles.DEFAULT_SHADE_COLOR : _props$shadeColor,
            _props$headerCellColo = props.headerCellColor,
            headerCellColor = _props$headerCellColo === undefined ? _styles.DEFAULT_HEADER_CELL_COLOR : _props$headerCellColo,
            _props$bodyCellColor = props.bodyCellColor,
            bodyCellColor = _props$bodyCellColor === undefined ? _styles.DEFAULT_BODY_CELL_COLOR : _props$bodyCellColor,
            _props$keyCellColor = props.keyCellColor,
            keyCellColor = _props$keyCellColor === undefined ? _styles.DEFAULT_KEY_CELL_COLOR : _props$keyCellColor;

        return new _DataStore2.default(data, { shadeColor: shadeColor, headerCellColor: headerCellColor, bodyCellColor: bodyCellColor, keyCellColor: keyCellColor });
    };

    this.isFixed = function (index) {
        return index < 2;
    };

    this.renderChildren = function (props) {
...
ReactCohortGraph.propTypes = {
    ...
    dataType: _propTypes2.default.string, //keys of data
    defaultValueType: _propTypes2.default.string, //["value", "percent"]
    ...
    shadeColor: _propTypes2.default.string, //#3f83a3
    headerCellColor: _propTypes2.default.string,
    ...
    toggleValues: _propTypes2.default.bool,
    showHeaderValues: _propTypes2.default.bool,
    onStoreUpdate: _propTypes2.default.func, //function(store, currentType, valueType)
    //Styles
    headerCellStyles: _propTypes2.default.object,
    bodyCellStyles: _propTypes2.default.object,
    tableCellStyles: _propTypes2.default.object,
    tableStyles: _propTypes2.default.object,
    tableRowStyles: _propTypes2.default.object,
    tableHeadingStyles: _propTypes2.default.object,
    tableBodyStyles: _propTypes2.default.object,
    fixedTablePartStyles: _propTypes2.default.object,
    wrapperStyles: _propTypes2.default.object,
    scrollableTablePartStyles: _propTypes2.default.object,
    scrollableTableContentStyles: _propTypes2.default.object,
    headerValueStyles: _propTypes2.default.object,
    headerLabelStyles: _propTypes2.default.object
};

exports.default = ReactCohortGraph;
...
var _initialiseProps = function _initialiseProps() {
                ...
                var _loop2 = function _loop2(anotherKey) {
                    if (data[key].hasOwnProperty(anotherKey)) {
                        ...
                        _this.store[key].push([cellData].concat(_toConsumableArray(data[key][anotherKey].map(function (value, index) {
                            ...
                            return _ref = {
                                type: key
                            }, _defineProperty(_ref, VALUE, value), _defineProperty(_ref, 'valueFor', anotherKey), _defineProperty(_ref, 'total', cellData.total), _defineProperty(_ref, 'isTotal', index === 0), _defineProperty(_ref, PERCENT, percent), _defineProperty(_ref, 'color', index === 0 ? _this.options.bodyCellColor : _this._shadeCellWithColor(percent, _this.options.shadeColor)), _ref;
                        }))));
                    }
                };
        ...
        var _loop3 = function _loop3(key) {
            if (_this.store.hasOwnProperty(key)) {
                ...
                _this.headers[key].push({ //first cell
                    value: "", //TODO:
                    color: _this.options.headerCellColor,
                    isLabel: true,
                ...
                largeRow.forEach(function (el, index) {
                    ...
                    _this.headers[key].push((_this$headers$key$pus = {
                        ...
                        index: index,
                        type: key
                    }, _defineProperty(_this$headers$key$pus, VALUE, value), _defineProperty(_this$headers$key$pus, 'valueFor', largeRow[0]), _defineProperty(_this$headers$key$pus, 'total', cellData.total), _defineProperty(_this$headers$key$pus, PERCENT, percent), _defineProperty(_this$headers$key$pus, 'color', _this._shadeCellWithColor(percent, _this.options.shadeColor)), _defineProperty(_this$headers$key$pus, 'label', labelPrefix + ' ' + (index - 1)), _this$headers$key$pus));
                });
            }
        };
    ...
    this._sumOfFirstColumnUpToIndex = function (arr, index, baseIndex) {
        var sum = 0;
...
exports.ScrollableContent = exports.BodyCell = exports.HeaderCell = undefined;
...
var renderHeader = function renderHeader(props) {
    var headerFormatter = props.headerFormatter,
        label = props.label;
...
var HeaderCell = exports.HeaderCell = function HeaderCell(props) {
    return _react2.default.createElement(
        ...
        props.showHeaderValues ? _react2.default.createElement(
            'span',
            { style: (0, _styles.headerValue)({}) },
            renderValue(props)
        ) : null
    );
};

var BodyCell = exports.BodyCell = function BodyCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, (0, _styles.tableCell)(props.tableCellStyles), { backgroundColor: props.color }, props.style), title: 'Out of ' + props.total + ' on ' + props.valueFor },
        renderValue(props)
    );
};

var ScrollableContent = exports.ScrollableContent = function (_React$Component) {
    _inherits(ScrollableContent, _React$Component);

    function ScrollableContent(props) {
        _classCallCheck(this, ScrollableContent);

        var _this = _possibleConstructorReturn(this, (ScrollableContent.__proto__ || Object.getPrototypeOf(ScrollableContent)).call(this, props));

        _this.setWidth = function () {
            if (_this.ref && _this.ref.parentNode) {
                try {
                    _this.setState({ width: _this.ref.parentNode.clientWidth - 1 });
                } catch (e) {
                    //console.error(e);
                }
            }
    ...
    _createClass(ScrollableContent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(x) {
                        return _this3.ref = x;
                    }, style: _extends({}, (0, _styles.scrollableTableContent)(scrollableTableContentStyles), { width: this.state.width }) },
                this.props.children
            );
        }
    }]);
