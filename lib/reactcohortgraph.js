...
var TableHeading = exports.TableHeading = {
...
var TableBody = exports.TableBody = {
...
var HeaderValue = exports.HeaderValue = {
    fontSize: '12px'
};

var HeaderLabel = exports.HeaderLabel = {
    fontSize: '16px',
    padding: '0',
    margin: '0'
};

var FixedTablePart = exports.FixedTablePart = {
    display: 'table-cell',
    minWidth: '200px'
};

var ScrollableTableContent = exports.ScrollableTableContent = {
    position: 'relative',
    display: 'block'
};

var ScrollableTablePart = exports.ScrollableTablePart = {
    display: 'table-cell',
    overflowX: 'auto',
    whiteSpace: 'nowrap',
    width: "100%",
...
var ReactCohortGraph = function (_React$Component) {
    ...
    function ReactCohortGraph(props) {
        ...
        _this.state = {
            dataStore: new _DataStore2.default({}),
            currentType: "",
...
var HeaderCell = exports.HeaderCell = function HeaderCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, _styles.TableCell, { backgroundColor: props.color }, props.style) },
        _react2.default.createElement(
            'p',
            { style: _styles.HeaderLabel },
            props.label
        ),
        _react2.default.createElement(
            'span',
            { style: _styles.HeaderValue },
            renderValue(props)
        )
    );
};
...
var BodyCell = exports.BodyCell = function BodyCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, _styles.TableCell, { backgroundColor: props.color }, props.style), title: 'Out of ' + props.total + ' on ' + props.valueFor },
        renderValue(props)
    );
};
    ...
    _createClass(ScrollableContent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(x) {
                        return _this3.ref = x;
                    }, style: _extends({}, _styles.ScrollableTableContent, { width: this.state.width }) },
                this.props.children
            );
        }
    }]);
