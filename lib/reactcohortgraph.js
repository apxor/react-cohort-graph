...
var ReactCohortGraph = function (_React$Component) {
    ...
    function ReactCohortGraph(props) {
        ...
        var _props$showEmptyDataM = props.showEmptyDataMessage,
            showEmptyDataMessage = _props$showEmptyDataM === undefined ? true : _props$showEmptyDataM,
            customEmptyDataMessage = props.customEmptyDataMessage,
            ...
            columnClickEvent = props.columnClickEvent,
            showAbsolute = props.showAbsolute,
            toggleValues = props.toggleValues,
            shadeColor = props.shadeColor;

        _this.state = {
            dataStore: new _DataStore2.default({}, { shadeColor: shadeColor }),
            currentType: "",
    ...
    _createClass(ReactCohortGraph, [{
        ...
        value: function componentWillMount() {
            var _props = this.props,
                ...
                shadeColor = _props.shadeColor;

            var keys = Object.keys(data);
            if (keys.length > 0) {
                var store = new _DataStore2.default(data || { shadeColor: shadeColor });
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var keys = Object.keys(data);
            if (keys.length > 0) {
                var store = new _DataStore2.default(data || {});
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            header.map(function (headerCell, i) {
                                                return _this2.isFixed(i) && _react2.default.createElement(_components.HeaderCell, _extends({ headerLabelStyles: headerLabelStyles, style: headerCellStyles, key: "header" + i }, headerCell, { valueType: valueType }));
                                            })
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            ...
                                            rows.map(function (row, j) {
                                                return _react2.default.createElement(
                                                    ...
                                                    row.map(function (cell, k) {
                                                        return _this2.isFixed(k) && _react2.default.createElement(_components.BodyCell, _extends({ style: bodyCellStyles, key: "cell" + k }, cell, { valueType: valueType, labelFormatter: labelFormatter }));
                                                    })
                                                );
                                            })
                                        )
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                { style: TableHeadingStyles },
                                                header.map(function (headerCell, i) {
                                                    return !_this2.isFixed(i) && _react2.default.createElement(_components.HeaderCell, _extends({ style: headerCellStyles, key: "header" + i }, headerCell, { valueType: valueType }));
                                                })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                ...
                                                rows.map(function (row, j) {
                                                    return _react2.default.createElement(
                                                        ...
                                                        { style: TableRowStyles, key: "row" + j },
                                                        row.map(function (cell, k) {
                                                            return !_this2.isFixed(k) && _react2.default.createElement(_components.BodyCell, _extends({ style: bodyCellStyles, key: "cell" + k }, cell, { valueType: valueType }));
                                                        })
                                                    );
                                                })
                                            )
                ...
                var _loop2 = function _loop2(anotherKey) {
                    if (data[key].hasOwnProperty(anotherKey)) {
                        ...
                        _this.store[key].push([cellData].concat(_toConsumableArray(data[key][anotherKey].map(function (value, index) {
                            ...
                            return _ref = {
                                type: key
                            }, _defineProperty(_ref, VALUE, value), _defineProperty(_ref, 'valueFor', anotherKey), _defineProperty(_ref, 'total', cellData.total), _defineProperty(_ref, 'isTotal', index === 0), _defineProperty(_ref, PERCENT, percent), _defineProperty(_ref, 'color', index === 0 ? _styles.DEFAULT_CELL_COLOR : _this._shadeCellWithColor(percent, _this.shadeColor)), _ref;
                        }))));
                    }
                };
...
var HeaderCell = exports.HeaderCell = function HeaderCell(props) {
    return _react2.default.createElement(
        'div',
        { style: _extends({}, (0, _styles.tableCell)({}), { backgroundColor: props.color }, props.style) },
        _react2.default.createElement(
            'p',
